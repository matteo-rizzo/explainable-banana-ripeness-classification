...
from src.cv.classifiers.deep_learning.classes.modules.cnn.CNN import CNN
from src.cv.classifiers.deep_learning.classes.modules.mobilenet_v2.MobileNetV2 import MobileNetV2
from src.cv.classifiers.deep_learning.classes.modules.pre_trained_vit.PreTrainedViT import PreTrainedViT
