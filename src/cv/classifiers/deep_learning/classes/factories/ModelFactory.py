...
from src.cv.classifiers.deep_learning.classes.modules.cnn.ModelCNN import ModelCNN
from src.cv.classifiers.deep_learning.classes.modules.mobilenet_v2.ModelMobileNetV2 import ModelMobileNetV2
from src.cv.classifiers.deep_learning.classes.modules.pre_trained_vit.ModelPreTrainedViT import ModelPreTrainedVit
